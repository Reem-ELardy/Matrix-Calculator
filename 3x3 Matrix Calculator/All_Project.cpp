...
int Addition ( double matrixA [3] [3] , double matrixB [3] [3] )
{
...
int Subtraction ( double matrixA [3] [3] , double matrixB [3] [3] )
{
     for ( int row = 0 ; row < 3 ; row ++ )
      {
            for ( int col = 0 ; col < 3 ; col ++ )
...
void choose ( int x )
{
     switch ( x )
    {
        ...
        case 5 :
            Determinate ( matrixA , rowA ) ;
            break ;

        case 6 :
            Determinate ( matrixB , rowB ) ;
            break;
